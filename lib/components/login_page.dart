...
class _LoginPageState extends State<LoginPage> {
  ...
  void _handleLoginUser() async {
    if (_loginFormKey.currentState!.validate()) {
      String email = ""; // Kullanıcının girdiği email burada olacak
      String password = ""; // Kullanıcının girdiği şifre burada olacak

      // API Servisi kullanarak doğrulama yap
      try {
        ...
        if (user != null) {
          ...
          // Kullanıcı doğrulama başarısızsa hata mesajı göster
